...
$finalString = "java -jar compiler/compiler.jar --compilation_level ADVANCED_OPTIMIZATIONS ";
function embed($src) {
    $GLOBALS["finalString"] .= " --js " .$src;
}
...
$finalString .= " --js_output_file hello-compiled.js";
echo shell_exec($finalString);